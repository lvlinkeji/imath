...
RUN curl -sS -o - https://dl-ssl.google.com/linux/linux_signing_key.pub | apt-key add - && \
    # curl -sS https://dl-ssl.google.com/linux/linux_signing_key.pub | tee /usr/share/keyrings/google-cloud-apt-keyring.gpg > /dev/null && \
